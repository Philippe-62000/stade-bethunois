  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const res = await fetch('/api/auth/change-password', {
        ...
        credentials: 'include',
        body: JSON.stringify({
          currentPassword: formData.currentPassword || undefined, // Optionnel pour code provisoire
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">
                Mot de passe actuel (optionnel si vous utilisez un code provisoire)
              </label>
              <input
                type="password"
                ...
                placeholder="Laisser vide si code provisoire"
              />
            </div>
